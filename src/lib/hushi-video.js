...
function getJsonTextDirectEnterConf(serverAddress, serverPort, userNickname, confID) {
  var jsonText = '{' +
    '"Server": {' +
...
export default function (serverAddress, serverPort, userNickname, confID) {
  var jsonText = getJsonTextDirectEnterConf(serverAddress, serverPort, userNickname, confID);
  var jsonTextBase64 = base64encode(utf16to8(jsonText));

  //"114.55.29.216","17979","lmw","1515045892907"
  Vue.jsonp("http://127.0.0.1:17979/IMConf", {
    URL: `IMConf://${jsonTextBase64}/`,
    callbackName:"IMConfHandler"
  }).then((res)=>{
      console.log(res);
  }).catch(err => {
    console.log(err)
